...
<body>
    <center>
    <form action="Lab9_2modtfy.php" method="POST">
...
echo '<tr><td colspan="3" align="center">Max:',max($score),'คนที่:',ma($score);
echo '<tr><td colspan="3" align="center">Min:',min($score),'คนที่:',mi($score);
echo '</td></tr>';
echo '</table>';
echo '<center>';

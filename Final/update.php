...
<body>
   <div class="container">
        <div class="row">
            <div class="co-l-12 mt-5 text-center">
                <h1> Update Data </h1>
            </div>
            <div class="co-l-12 text-center mb-3">
        ...
        <div class="col-12 mb-3">
            ...
            <textarea type="text" name="p_des" class="form-control"><?=$data['p_des']?></textarea>
        </div>
        <div class="col-6 mb-3">
            <label for="p_price" class="form-label">ราคาสินค้า</label>
            <input type="number" value="<?=$data['p_price']?>" min="0" name="p_price" class="form-control">
        </div>
        <div class="col-6 mb-3">
            <label for="p_pic" class="form-label">อัพโหลดรูป</label>
            <input type="file" name="p_pic" class="form-control">
        </div>
        <div class="col-12 d-flex justify-content-end">
            <button name="updateData" class="btn btn-primary">บันทึกข้อมูล</button>
        </div>  
